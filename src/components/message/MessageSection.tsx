        ...
        <div className="grid h-full grid-cols-1 gap-8 py-8 lg:grid-cols-2">
          ...
          <div className="flex h-full flex-col rounded-lg bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark shadow-sm">
            <div className="border-b border-border-light dark:border-border-dark p-4">
              <h3 className="text-lg font-bold text-neutral-text-light dark:text-neutral-text-dark">
                Symptom Checker
              </h3>
            ...
            <div className="flex-grow space-y-6 overflow-y-auto p-4">
              ...
              <div className="flex items-end gap-3">
                ...
                <div className="flex flex-1 flex-col gap-1 items-start">
                  <p className="text-secondary-text-light dark:text-secondary-text-dark text-[13px] font-medium">
                    AI Assistant
                  </p>
                  <p className="text-base font-normal leading-normal flex max-w-md rounded-lg px-4 py-3 bg-background-light dark:bg-background-dark text-neutral-text-light dark:text-neutral-text-dark">
              ...
              <div className="flex items-end gap-3 justify-end">
                <div className="flex flex-1 flex-col gap-1 items-end">
                  ...
                  <p className="text-base font-normal leading-normal flex max-w-md rounded-lg px-4 py-3 bg-primary text-white">
            ...
            <div className="border-t border-border-light dark:border-border-dark p-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button className="px-4 py-2 text-sm font-medium text-primary border border-primary/50 rounded-full bg-primary/10 hover:bg-primary/20">
                  Headache
                </button>
                <button className="px-4 py-2 text-sm font-medium text-primary border border-primary/50 rounded-full bg-primary/10 hover:bg-primary/20">
                  Fever
              ...
              <div className="relative">
                <input
                  className="w-full rounded-lg border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark py-2.5 pl-4 pr-12 text-sm focus:border-primary focus:ring-primary dark:placeholder-secondary-text-dark"
                  placeholder="Type your symptoms here..."
                  type="text"
                />
                <button className="absolute inset-y-0 right-0 flex items-center justify-center px-4 text-primary hover:text-primary/80">
          ...
          <div className="flex h-full flex-col space-y-6 overflow-y-auto rounded-lg bg-surface-light dark:bg-surface-dark p-6 border border-border-light dark:border-border-dark shadow-sm">
            ...
            <div className="rounded-lg border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark p-4">
              <h4 className="font-bold text-neutral-text-light dark:text-neutral-text-dark mb-3">
                Your Summary
              </h4>
            ...
            <div className="flex-grow space-y-3">
              <h4 className="font-bold text-neutral-text-light dark:text-neutral-text-dark">
                Preliminary Diagnosis
              </h4>
              <p className="text-sm text-secondary-text-light dark:text-secondary-text-dark">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 rounded-lg bg-gray-500/10 p-4">
                <span className="material-symbols-outlined text-2xl text-secondary-text-light dark:text-secondary-text-dark">
                  hourglass_empty
                </span>
                <p className="text-sm text-secondary-text-light dark:text-secondary-text-dark">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg bg-primary/30 px-4 py-3 text-sm font-bold text-white">
                  <span className="material-symbols-outlined">
                    person_search
                  </span>{" "}
                  Find a Doctor
                </button>
                <button className="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg bg-accent-red/30 px-4 py-3 text-sm font-bold text-white">
