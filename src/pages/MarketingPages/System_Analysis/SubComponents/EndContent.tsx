            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-lg text-light">We are committed to continuous innovation. Our development roadmap is focused on expanding our AI capabilities to address the evolving needs of modern healthcare.</p>
                        <div className="mt-8 space-y-6">
                            <div className="light:bg-white p-6 rounded-lg shadow-sm">
                                ...
                                <p className="mt-1 text-gray-450 text-sm">AI generation of treatment plan recommendations based on patient genetics, lifestyle, and medical history.</p>
                            </div>
                            <div className="light:bg-white p-6 rounded-lg shadow-sm">
                                <p className="text-sm font-bold text-accent">Q2 2025</p>
                                <h3 className="mt-1 font-semibold">Real-Time Patient Monitoring</h3>
                                <p className="mt-1 text-gray-450 text-sm">Integration with wearable devices for proactive health monitoring and anomaly detection.</p>
                            </div>
                            <div className="light:bg-white p-6 rounded-lg shadow-sm">
                                <p className="text-sm font-bold text-accent">Q4 2025</p>
                                <h3 className="mt-1 font-semibold">Voice-Enabled Clinical Notes</h3>
                                <p className="mt-1 text-gray-450 text-sm">Advanced voice recognition and NLP for hands-free, real-time documentation during patient consultations.</p>
                            </div>
                        </div>
                    </div>
                </div>
