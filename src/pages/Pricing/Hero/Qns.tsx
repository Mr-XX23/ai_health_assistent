    ...
    return (
        <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-primary/10 dark:bg-primary/20 p-8 sm:p-12 rounded-xl text-center">
                <h2 className="text-3xl font-black text-primary dark:text-white">Not sure which plan is right for you?</h2>
                <p className="mt-4 text-lg max-w-2xl mx-auto text-subtext-light dark:text-subtext-dark">Explore MediSecure with a personalized demo or a 14-day free trial of our Premium plan. No credit card required.</p>
