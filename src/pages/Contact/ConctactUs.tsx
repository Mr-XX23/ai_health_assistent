            ...
            <section className="py-20 md:py-32">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter">Get in Touch</h1>
                        <p className="mt-4 max-w-2xl mx-auto text-lg text-light">We’re here to help and answer any question you might have. We look forward to hearing from you.</p>
                    </div>
                    <div className="mt-16 grid lg:grid-cols-5 gap-12">
                        <div className="lg:col-span-3">
                            <div className="light:bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg ">
                                <h2 className="text-2xl font-bold text-light">Send us a message</h2>
                                <form action="#" className="mt-6 space-y-6" method="POST">
                                    <div>
                                        <label className="block text-sm font-medium text-light" htmlFor="name">
                                            Full Name
                                        </label>
                                        <div className="mt-1">
                                            <input
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-light" htmlFor="email">
                                            Email Address
                                        </label>
                                        <div className="mt-1">
                                            <input
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-light" htmlFor="subject">
                                            Subject
                                        </label>
                                        <div className="mt-1">
                                            <input
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-light" htmlFor="message">
                                            Message
                                        </label>
                                        <div className="mt-1">
                                            <textarea
                        ...
                        <div className="lg:col-span-2">
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <p className="mt-2 text-gray-400">Our team is available to answer your questions.</p>
                                    <div className="mt-4 space-y-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-400">123 Health Tech Avenue, Suite 100<br />San Francisco, CA 94103</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
