...
const Sidebar = () => {
  ...
  ${
    isActive
      ? "text-black dark:text-white bg-blue-100  dark:bg-blue-900/30 "
      : "text-secondary dark:text-secondary dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800"
  }`;
  return (
    <div>
